  ...
  switch (channel) {
    ...
    case "beta": {
      return {
        ...base,
        appId,
        productName: "Somatic Beta",
        // The url scheme stays "opencode": it is registered with the OS and
        // changing it breaks every existing deep link.
        protocols: { name: "Somatic Beta", schemes: ["opencode"] },
    ...
    case "prod": {
      return {
        ...
        appId,
        productName: "Somatic",
        protocols: { name: "Somatic", schemes: ["opencode"] },
