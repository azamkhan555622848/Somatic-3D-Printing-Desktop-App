...
import { Coder3dDelegateBadge, useClaudeDelegateActive } from "@/components/coder3d/delegate-badge"
...
export function PromptInputV2Composer(props: PromptInputV2ComposerProps) {
  ...
  // 3D-Coder: with the Claude delegate connected, the chat-model pickers are
  // hidden behind a static badge — see delegate-badge.tsx for the rationale.
  const delegateActive = useClaudeDelegateActive()
  ...
  return (
    <div class="flex flex-col gap-3">
      <PromptInputV2
        ...
        class={props.class}
        variantControlVisible={!props.controller.model.loading && !delegateActive()}
        attachKeybind={command.keybindParts("file.attach")}
        attachShortcut={command.keybind("file.attach")}
        modelControl={
          <Show
            when={!delegateActive()}
            fallback={<Coder3dDelegateBadge />}
          >
