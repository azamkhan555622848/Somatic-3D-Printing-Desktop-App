...
const icons = {
  ...
  "image-plus": {
    viewBox: "0 0 16 16",
    body: `<path d="M2 3H10.5V13H2V3Z" stroke="currentColor"/><path d="M3.5 10L5.5 8L7 9.5L8.5 8L10.5 10" stroke="currentColor" stroke-linejoin="round"/><path d="M6 6.25C6 6.66421 5.66421 7 5.25 7C4.83579 7 4.5 6.66421 4.5 6.25C4.5 5.83579 4.83579 5.5 5.25 5.5C5.66421 5.5 6 5.83579 6 6.25Z" fill="currentColor"/><path d="M12.75 3.5V8.5M10.25 6H15.25" stroke="currentColor"/>`,
  },
  "arrow-up": {
    viewBox: "0 0 16 16",
    body: `<path d="M8 13V3M4.5 6.5L8 3L11.5 6.5" stroke="currentColor" stroke-linecap="square" stroke-linejoin="round"/>`,
  },
  "settings-gear": {
    viewBox: "0 0 16 16",
